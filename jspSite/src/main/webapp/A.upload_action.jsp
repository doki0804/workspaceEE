...
<hr/>
<ul>
<li>application.getRealPath(""): <%=application.getRealPath("/WEB-INF/upload") %>
<li>name:<%=multipartRequest.getParameter("name") %></li>
<li>fileone:<%=multipartRequest.getFilesystemName("fileone") %>
<li>filetwo:<%=multipartRequest.getFilesystemName("filetwo") %>
</ul>
