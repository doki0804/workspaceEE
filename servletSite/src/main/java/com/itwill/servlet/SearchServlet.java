...
public class SearchServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*
		 * 클라이언트 요청 URL
		 * http://192.168.15.18/servletSite/search.do?searchkeyword=java
		 * http://192.168.15.18/servletSite/search.do?searchkeyword=
		 * http://192.168.15.18/servletSite/search.do
		 */
